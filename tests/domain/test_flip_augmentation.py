...
import hivemind.training.data_loaders as data_loaders_module
from hivemind.training.data_loaders import (
    RLDataset,
    StreamingRLDataset,
...
def test_with_real_data():
    ...
    data_dir = str(PROJECT_ROOT / "engine/selfplay_games/training_data_parquet")
