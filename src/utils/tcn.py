...
def _move_dict_to_obj(move_dict):
    move_obj = chess.Move(
        from_square=chess.parse_square(move_dict['to_square']) if move_dict[
                                                                      'from_square'] is None else chess.parse_square(
            move_dict['from_square']),
        ...
        promotion=None if move_dict['promotion'] is None else chess.Piece.from_symbol(
            move_dict['promotion']).piece_type,
    )
    return move_obj
