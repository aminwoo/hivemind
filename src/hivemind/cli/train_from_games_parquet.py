...
4) Produce checkpoints in artifacts/training/weights/supervised

Example:
    hivemind prepare --games data/games.parquet
"""
...
from hivemind.paths import PROJECT_ROOT, TRAINING_OUTPUT_DIR

from hivemind.data.generate_planes import generate_planes
...
def _run_supervised_training(
    ...
    train_dir = project_root / "artifacts" / "training"
...
def main() -> None:
    ...
    supervised_weights = TRAINING_OUTPUT_DIR / "weights" / "supervised"
