...
from hivemind.constants import NUM_BUGHOUSE_CHANNELS, NUM_BUGHOUSE_CHANNELS_PER_BOARD
from hivemind.training.data_loaders import flip_bughouse_sample, load_rl_parquet_shard
...
def main():
    parser = argparse.ArgumentParser(description="Display board-swap augmentation")
    parser.add_argument("--data-dir", type=Path,
                        default=PROJECT_ROOT / "engine/selfplay_games/training_data_parquet")
