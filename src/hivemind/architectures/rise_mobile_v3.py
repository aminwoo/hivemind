...
from hivemind.architectures.builder_util import get_act, _ValueHead, _PolicyHead,\
    _Stem, process_value_policy_head, _BottlekneckResidualBlock, ClassicalResidualBlock, round_to_next_multiple_of_32
from hivemind.architectures.next_vit_official_modules import NCB
from hivemind.architectures.next_vit_official_modules import NTB
...
def _rise_v33_options(args):
    """Common convolutional body and head options for the RISEv3.3 family."""
    kernels = [3] * 15
...
def get_rise_v33_model(args):
    """Build the convolutional RISEv3.3 model."""
    return RiseV3(
        **_rise_v33_options(args), dropout_rate=0, use_avg_features=False,
