...
// The fixed variant set of this build cannot be extended from a file, so the
// option is accepted and ignored rather than removed, keeping the option list
// the same shape as upstream.
void on_variant_path(const Option&) {}
